...
class ListLocations extends React.Component {
	...
	render(){
		return (
			<div className="ui relaxed divided list" style={{backgroundColor:'#1bb8c8', padding:'10px', margin:'10px'}}>
				{this.renderList()}
			</div>
		);
	}
...
export default connect(mapStateToProps, {getOffices})(ListLocations);